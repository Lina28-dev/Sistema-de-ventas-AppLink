                                        ...
                                        <div class="row" id="productosLista">
                                            <div class="col-md-4 mb-3">
                                                <div class="card product-card" onclick="agregarAlCarrito(1, 'Panty Invisible Clásico', 24990, 15)">
                                                    <div class="card-body text-center">
                                                        <img src="/gestor-ventas-lilipink-main/public/img/panty-invisible.jpg" alt="Panty Invisible Clásico" class="img-fluid mb-2" style="max-height:120px;object-fit:contain;">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card product-card" onclick="agregarAlCarrito(2, 'Brasier Push Up Encaje', 59990, 8)">
                                                    <div class="card-body text-center">
                                                        <img src="/gestor-ventas-lilipink-main/public/img/brasier-pushup.jpg" alt="Brasier Push Up Encaje" class="img-fluid mb-2" style="max-height:120px;object-fit:contain;">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card product-card" onclick="agregarAlCarrito(3, 'Pijama Short Algodón', 79990, 5)">
                                                    <div class="card-body text-center">
                                                        <img src="/gestor-ventas-lilipink-main/public/img/pijama-short.jpg" alt="Pijama Short Algodón" class="img-fluid mb-2" style="max-height:120px;object-fit:contain;">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card product-card" onclick="agregarAlCarrito(4, 'Camiseta Manga Corta', 29990, 12)">
                                                    <div class="card-body text-center">
                                                        <img src="/gestor-ventas-lilipink-main/public/img/camiseta-mc.jpg" alt="Camiseta Manga Corta" class="img-fluid mb-2" style="max-height:120px;object-fit:contain;">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card product-card" onclick="agregarAlCarrito(5, 'Bóxer Algodón', 19990, 20)">
                                                    <div class="card-body text-center">
                                                        <img src="/gestor-ventas-lilipink-main/public/img/boxer-algodon.jpg" alt="Bóxer Algodón" class="img-fluid mb-2" style="max-height:120px;object-fit:contain;">
                                                        <h6>Bóxer Algodón</h6>
                                            ...
                                            <div class="col-md-4 mb-3">
                                                <div class="card product-card" onclick="agregarAlCarrito(6, 'Medias Tobilleras', 9990, 30)">
                                                    <div class="card-body text-center">
                                                        <img src="/gestor-ventas-lilipink-main/public/img/medias-tobilleras.jpg" alt="Medias Tobilleras" class="img-fluid mb-2" style="max-height:120px;object-fit:contain;">
